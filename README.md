...
#To use it: Download scala-sbt.org
for windows just install the msi. For the others, unpack the zip and puth the bin directory
 within the PATH variable (.bashrc)
